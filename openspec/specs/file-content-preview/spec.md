# file-content-preview Specification

## Purpose

Define the HTTP contract for **read-only text preview** of a file path under the allowed root (size limits, UTF-8, errors for non-files and binary).
## Requirements
